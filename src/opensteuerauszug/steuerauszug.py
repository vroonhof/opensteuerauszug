...
def run_pipeline(
    ...
    run_phases_input: Optional[List[Phase]] = None,
    debug_dump_path: Optional[Path] = None,
    final_xml_path: Optional[Path] = None,
    raw_import: bool = False,
    importer_type: ImporterType = ImporterType.NONE,
    period_from_str: Optional[str] = None,
    period_to_str: Optional[str] = None,
    tax_year: Optional[int] = None,
    identifiers_csv_path_opt: Optional[str] = None,
    strict_consistency_flag: bool = True,
    filter_to_period_flag: bool = True,
    tax_calculation_level: TaxCalculationLevel = TaxCalculationLevel.KURSLISTE,
    ...
    pre_amble: Optional[List[Path]] = None,
    post_amble: Optional[List[Path]] = None,
):
