...
def test_download_with_convert():
    with (
        patch("opensteuerauszug.kursliste.__main__.get_latest_initial_export") as mock_latest,
        ...
        patch(
            "opensteuerauszug.kursliste.__main__.convert_kursliste_xml_to_sqlite"
        ) as mock_convert,
